    ...
    <div class="bg-white p-6 rounded-lg shadow-md w-[800px]">
        ...
        <form action={{ route('post.update', ['blog' => $blog->id]) }} method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="input1" name="title" value="{{ $blog->title }}" class="w-full p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400">
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea id="textarea" name="content" rows="4"  class="w-full p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 h-[350px]">{{ $blog->content }}</textarea>
            </div>

            <button type="submit" class="w-full bg-blue-500 text-white py-2 rounded-lg hover:bg-blue-600 transition">Güncelle</button>
        </form>
    </div>
